 ...
 */
final class Version20201111163306 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE review (id INT NOT NULL, book_id INT NOT NULL, rating SMALLINT NOT NULL, body VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, publication_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
